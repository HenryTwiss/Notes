...
\begin{document}
  ...
  \section{The Gamma Function}
    ...
    \subsection{Asymptotics}
      We now turn to analyzing the growth rate of the gamma function itself. In fact, we can obtain a well-known asymptotic formula for the gamma function known as \textbf{Stirling's formula}.
