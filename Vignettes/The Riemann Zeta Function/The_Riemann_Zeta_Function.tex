  ...
  \section{The Riemann Zeta Function}
    ...
    \subsection{A Second Moment Estimate}
      ...
      \begin{proof}
        ...
        \end{equation}
        For the second piece, write \(n = m-r\) where \(1 \le r \le \frac{m}{2}\) so that \(\log\left(\frac{m}{n}\right) = -\log(1-\frac{r}{m})\). Using Taylor series expansion of \(log(1-z)\) about \(z = 0\), it follows that \(\log\left(\frac{m}{n}\right) \ge \frac{r}{m}\). Whence
        \[
