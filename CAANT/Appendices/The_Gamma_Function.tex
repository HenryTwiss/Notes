\section{The Gamma Function}\label{sec:the_gamma_function}
  ...
  \[
    \G(s+1) = s\G(s),
  \]
  is referred to as the \textbf{functional equation}\index{functional equation} of the gamma function. The functional equation will allow for the meromorphic conduction of the Gamma function to all of \(\C\).
