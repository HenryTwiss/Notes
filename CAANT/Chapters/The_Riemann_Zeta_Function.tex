\chapter{The Riemann Zeta Function}
  ...
  \section{A Second Moment Estimate}
    ...
    \begin{proof}
      ...
      \]
      where \(t(x) = \inf\left\{t \ge 2:\frac{t}{\sqrt{\log(t)}} \gg x\right\}\) with the same implicit constant. Separating the terms for which \(n = m\) or not, the right-hand side becomes
      \[
