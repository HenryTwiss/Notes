\chapter{Dirichlet Characters and Exponential Sums}
  ...
  \section{Quadratic Gauss Sums}
    ...
    \begin{proof}
      ...
      \]
      Then \(f(x)\) satisfies the Dirichlet-Jordan test and therefore Poisson summation applies where \(f(n)\) is understood to be the average of the left-hand and right-hand limits at points of jump discontinuity. On the one hand, we have
      \[
        \sum_{n \in \Z}f(n) = g(m).
      \]
