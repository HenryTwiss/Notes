\chapter{Algebraic Integers}
  ...
  \section{Localization}
    ...
    \begin{proof}
      ...
      The last statement follows from the first isomorphism theorem since the valuation \(v_{\mf{p}}\) restricted to \(K^{\ast}\) is a surjective homomorphism and the kernel is precisely the set of units of \(\smc{O}_{\mf{p}}\). This completes the proof.
    \end{proof}
  ...
  \section{\todo{Dedekind Extensions}}
    ...
    \end{proposition}
    \begin{proof}
      Note that \(\mf{P}\) and \(\mf{p}\) are primes disjoint from \(D\). On the one hand, suppose \(\mf{P}\) is above \(\mf{p}\). Then \(\mf{P} \cap \smc{O} = \mf{p}\) and applying the first bijection in \cref{prop:localization_prime_bijection} gives
      \[
