\chapter{Algebraic Integers}
  ...
  \section{Integrality}
    Let \(B/A\) be a ring extension. We say that \(\b \in B\) is \textit{integral}\index{integral} over \(A\) if \(\b\) is the root of a monic polynomial \(f(x) \in A[x]\). In other words, \(\b\) satisfies an equation of the form
    \[
    ...
    \begin{proposition}\label{prop:integral_if_finitely_generated}
      Let \(B/A\) be a ring extension. Then \(\b_{1},\ldots,\b_{n} \in B\) are all integral over \(A\) if and only if \(A[\b_{1},\ldots,\b_{n}]\) is a finitely generated \(A\)-module. In particular, the elements of \(B\) that are integral over \(A\) form a ring.
    \end{proposition}
    \begin{proof}
    ...
    \begin{proposition}\label{prop:integrality_is_transitive}
      Let \(C/B/A\) be a ring extension. If \(C\) is integral over \(B\) and \(B\) is integral over \(A\) then \(C\) is integral over \(A\).
    \end{proposition}
    \begin{proof}
    ...
    \begin{proposition}\label{prop:field_of_fractions_AKBL}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L/K\) be a finite separable extension, and \(B\) be the integral closure of \(A\) in \(L\). Then every \(\l \in L\) is of the form
      \[
        \l = \frac{\b}{\a},
      \]
      for some \(\b \in B\) and nonzero \(\a \in A\). In particular, \(L\) is the field of fractions of \(B\) and \(B\) is integrally closed. Moreover, \(\l \in L\) is integral over \(A\) if and only if the minimal polynomial \(m_{\l}(x)\) of \(\l\) over \(K\) has coefficients in \(A\).
    \end{proposition}
    \begin{proof}
    ...
    \[
      \k = \frac{\a}{a},
    \]
    for some algebraic integer \(\a\) and nonzero integer \(a\). In particular, \(K\) is the field of fractions of \(\mc{O}_{K}\) and \(\mc{O}_{K}\) is integrally closed. Moreover, \(\k\) is an algebraic integer if and only if the minimal polynomial \(m_{\k}(x)\) of \(\k\) over \(\Q\) has coefficients in \(\Z\).
  \section{Traces and Norms}
    ...
    \begin{proposition}\label{prop:trace_and_norm_AKBL}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L/K\) be a finite separable extension, and \(B\) be the integral closure of \(A\) in \(L\). If \(\b \in B\) then the trace and norm of \(\b\) are in \(A\).
    \end{proposition}
    \begin{proof}
    ...
    \begin{proposition}\label{prop:unit_if_and_only_if_AKBL}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L/K\) be a finite separable extension, and \(B\) be the integral closure of \(A\) in \(L\). Then \(\b \in B\) is a unit if and only if \(\Norm_{L/K}(\b) \in A\) is a unit.
    \end{proposition}
    \begin{proof}
    ...
    Having introduced traces and norms, we turn to discussing discriminants of free modules. Let \(B/A\) be a ring extension such that \(B\) is a free \(A\)-module of rank \(n\). If \(\b_{1},\ldots,\b_{n}\) is a basis for \(B/A\), we define its \textbf{trace matrix}\index{trace matrix} \(\Trace_{B/A}(\b_{1},\ldots,\b_{n})\) by
    \[
    ...
    \begin{proposition}\label{prop:discriminant_and_direct_sums}
      Let \(B/A\) be a ring extension such that \(B\) is a free \(A\)-module of rank \(n\). Suppose we have a direct sum decomposition
      \[
        B = B_{1} \op B_{2},
      \]
    ...
    \begin{lemma}\label{lem:lemma_for_integral_basis_AKBL}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L/K\) be a degree \(n\) separable extension, and \(B\) be the integral closure of \(A\) in \(L\). If \(\l_{1},\ldots,\l_{n}\) is a basis for \(L/K\) that is contained in \(B\) then
      \[
    ...
    \begin{proposition}\label{prop:linearly_disjoint_integral_basis}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L_{1}/K\) and \(L_{2}/K\) be degree \(n_{1}\) and \(n_{2}\) separable extensions, and \(B_{1}\) and \(B_{2}\) be the integral closures of \(A\) in \(L_{1}\) and \(L_{2}\) respectively. Suppose \(L_{1}\) and \(L_{2}\) are linearly disjoint over \(K\) in \(\conj{K}\) and that \(B_{1}/A\) and \(B_{2}/A\) admit integral bases \(\b_{1,1},\ldots,\b_{n_{1},1}\) and \(\b_{1,2},\ldots,\b_{n_{2},2}\) with
      \[
    ...
    \begin{proposition}\label{prop:trace_and_norm_reduce_for_integral_basis}
      Let \(A\) be integrally closed with field of fractions \(K\), \(L/K\) be a degree \(n\) separable extension, and \(B\) be the integral closure of \(A\) in \(L\). If \(B\) admits an integral basis over \(A\) then
      \[
  ...
  \section{Dedekind Domains}
    ...
    In view of principal ideal domains being integrally closed by \cref{lemma:unique_factorization_domains_are_integrally_closed}, they are Dedekind domains. In fact, Dedekind domains should be thought of as generalizations of principal ideal domains. As \(\Z\) is a prototypical example of a principal ideal domain, a Dedekind domain \(\smc{O}\) should be thought of as a generalization of \(\Z\). In fact, we will show that being a principal ideal domain is equivalent to being a unique factorization domain for \(\smc{O}\). So if \(\smc{O}\) is not a principal ideal domain then unique factorization fails. However, it will be possible to remedy most of this as one of our primary aims is to prove that integral ideals factor uniquely into a product of primes. This clearly generalizes unique factorization in \(\Z\) which will be enough. To this end, we first show containment in one direction for integral ideals.
  ...
  \section{Localization}
    ...
    \end{proposition}
    \begin{proof}
      To prove \(\smc{O}D^{-1}\) is integrally closed, let \(\k \in K\) be integral over \(\smc{O}D^{-1}\). Then
      \[
        \k^{n}+\frac{\eta_{n-1}}{\d_{n-1}}\k^{n-1}+\cdots+\frac{\eta_{0}}{\d_{0}} = 0,
      \]
      ...
      \[
        (\k\d)^{n}+\frac{\eta_{n-1}\d}{\d_{n-1}}(\k\d)^{n-1}+\cdots+\frac{\eta_{0}\d^{n}}{\d_{0}} = 0.
      \]
      Whence \(\k\d\) is the root of a monic polynomial with coefficients in \(\smc{O}\). As \(\smc{O}\) is integrally closed, \(\k\d \in \smc{O}\) and therefore \(\k \in \smc{O}D^{-1}\). This proves \(\smc{O}D^{-1}\) is integrally closed. To show it is noetherian, let \(\mf{A}\) be an ideal of \(\smc{O}D^{-1}\) and set \(\mf{a} = \mf{A} \cap \smc{O}\). Then
      \[
        \mf{A} = \mf{a}D^{-1}.
      \]
    ...
    \begin{proof}
      ...
      \]
      Note that \(\ker\phi = \mf{p}_{\mf{p}}^{n} \cap \smc{O}\). By \cref{prop:localization_prime_bijection}, \(\mf{p}_{\mf{p}} \cap \smc{O} = \mf{p}\) and the first isomorphism theorem induces the desired embedding when \(n = 1\). As \(\mf{p}_{\mf{p}}\) is maximal, \(\smc{O}_{\mf{p}}/\mf{p}_{\mf{p}}\) is a field and thus must be the field of fractions of \(\smc{O}/\mf{p}\) under this embedding. It remains to prove the last statement. So suppose \(\mf{p}\) is maximal. By the first isomorphism theorem again, it suffices to prove \(\phi\) is surjective and \(\ker\phi = \mf{p}^{n}\). Let \(\frac{\a}{\d}\) be a representative of a coset in \(\smc{O}_{\mf{p}}/\mf{p}_{\mf{p}}^{n}\). As \(\d \notin \mf{p}\) and \(\mf{p}\) is maximal, \(\d\) is a representative of an invertible element in the field \(\smc{O}/\mf{p}\). Whence there exists an \(\e \in \smc{O}\) such that
      \[
        \d\e \equiv 1 \mod{\mf{p}}.
      \]
      Then there is a \(\rho \in \mf{p}\) such that \(\frac{1}{\d} = \frac{\e}{1+\rho}\). Moreover, as \(\mf{p}\) is maximal \(1+\rho\) is a unit in \(\smc{O}\). So \(\frac{\a}{\d} = \frac{\a\e}{1+\rho}\) is an element of \(\smc{O}\) proving surjectivity. Now the identity
      \[
        \mf{p}_{\mf{p}}^{n} \cap \smc{O} = \mf{p}^{n}.
      \]
      follow by induction as \(\mf{p}_{\mf{p}} \cap \smc{O} = \mf{p}\). This forces \(\ker\phi = \mf{p}^{n}\).
    \end{proof}
    ...
    \begin{remark} 
      \cref{thm:Dedekind_if_and_only_if_all_localizations_are_discrete_valuation_rings,prop:ring_is_intersection_of_all_localizations} together provide a powerful simplification tool for studying a Dedekind domains \(\smc{O}\). For if we want to prove a property about a fractional ideal \(\mf{f}\) of \(\smc{O}\), \cref{prop:ring_is_intersection_of_all_localizations} reduces to showing that the desired property holds for the fractional ideals \(\mf{f}_{\mf{p}}\) corresponding to the localizations \(\smc{O}_{\mf{p}}\) at all primes \(\mf{p}\) and is preserved under intersection. But by \cref{thm:Dedekind_if_and_only_if_all_localizations_are_discrete_valuation_rings}, the localizations \(\smc{O}_{\mf{p}}\) are Dedekind domains with exactly one prime and hence principal ideal domains.
    \end{remark}

    Let \(v_{\mf{p}}\) denote the valuation of \(\smc{O}_{\mf{p}}\). We call \(v_{\mf{p}}\) the \textbf{valuation}\index{valulation} associated to the prime \(\mf{p}\) of \(\smc{O}\). These valuations are intimately connected to prime factorizations. Indeed, the prime factorization of fractional ideals implies that for any \(\k \in K^{\ast}\), we have
    \[
  ...
  \section{\todo{Dedekind Extensions}}
    Let \(\smc{O}\) be integrally closed with field of fractions \(K\), \(L/K\) be a finite separable extension, and \(\mc{O}\) be the integral closure of \(\smc{O}\) in \(L\). It turns out that \(\mc{O}\) will be Dedekind whenever \(\smc{O}\) is and the argument is similar to that of \cref{thm:ring_of_integers_is_Dedekind}.
    ...
    \[
      \mf{P} \cap \smc{O} = \mf{p}.
    \]
    \cref{cor:integral_closure_of_Dedekind_is_Dedekind} implies that every prime of \(\mc{O}\) is above exactly one prime of \(\smc{O}\). If \(\mf{P}\) is above \(\mf{p}\) then \(\mf{P} \mid \mf{p}\mc{O}\). Indeed, since \(\mf{p} \subseteq \mf{P}\) we have \(\mf{p}\mc{O} \subseteq \mf{P}\) which is to say that \(\mf{P}\) divides \(\mf{p}\mc{O}\). This implies that only finitely many primes \(\mf{P}\) can lie above a prime \(\mf{p}\) and they are exactly the prime factors of \(\mf{p}\mc{O}\). Moreover, every prime of \(\smc{O}\) is below at least one prime of \(\mc{O}\). This is equivalent to the fact that any integral ideal of the form \(\mf{p}\mc{O}\) satisfies
    \[
      \mf{p}\mc{O} \neq \mc{O}.
    \]
    Indeed, by the prime factorization of fractional ideals, choose \(\a \in \mf{p}-\mf{p}^{2}\) so that \(\a\smc{O} = \mf{p}\mf{a}\) for some integral ideal \(\mf{a}\) relatively prime to \(\mf{p}\). Then \(\mf{a}+\mf{p} = \smc{O}\) so there exist \(\b \in \mf{a}\) and \(\g \in \mf{p}\) with \(\b+\g = 1\). It follows that \(\b\mf{p} \subseteq \a\smc{O}\) and \(\b \notin \mf{p}\). Now if \(\mf{p}\mc{O} = \mc{O}\), it would follow that \(\b\mc{O} \subseteq \a\mc{O}\) which would imply \(\b = \a\d\) for some \(\d \in \mc{O}\). Then \(\a\d+\g = 1\) whence \(1 \in \mf{p}\) contradicting the fact that \(\mf{p}\) is proper. Equivalently, \(\mf{p}\mc{O}\) has at least one prime factor \(\mf{P}\). This also implies
    \[
      \mf{p}\mc{O} \cap \smc{O} = \mf{p},
    \]
    as the prime \(\mf{P}\) is above \(\mf{p}\) and \(\mf{P} \mid \mf{p}\mc{O}\). We illustrate the relationship between \(\mf{P}\) and \(\mf{p}\) via the following extension:
    ...
    Dedekind extensions are also well-behaved under localization. In view of \cref{prop:localization_of_Dedekind_is_Dedekind}, \(\mc{O}D^{-1}/\smc{O}D^{-1}\) is also a Dedekind extension of \(L/K\) for any multiplicative subset \(D\) of \(\smc{O}\). We call \(\mc{O}D^{-1}/\smc{O}D^{-1}\) the \textbf{localization}\index{localization} of \(\mc{O}/\smc{O}\) at \(D\). In the case of localizing at a prime \(\mf{p}\) of \(\smc{O}\), we call \(\mc{O}_{\mf{p}}/\smc{O}_{\mf{p}}\) the \textbf{localization}\index{localization} of \(\mc{O}/\smc{O}\) at \(\mf{p}\). We can also determine the ramification indices and inertia degrees of \(\mc{O}D^{-1}/\smc{O}D^{-1}\).

    \begin{proposition}\label{prop:ramification_setup_respects_localization}
      Let \(\mc{O}/\smc{O}\) be a Dedekind extension of a finite separable extension \(L/K\) and let \(D\) be a multiplicative subset of \(\smc{O}\). Then for the Dedekind extension \(\mc{O}D^{-1}/\smc{O}D^{-1}\) of \(L/K\), \(\mf{P}D^{-1}\) is above \(\mf{p}D^{-1}\) if and only if \(\mf{P}\) is above \(\mf{p}\). Moreover, there are isomorphisms
      \[
        \F_{\mf{P}D^{-1}} \cong \F_{\mf{P}} \quad \text{and} \quad \F_{\mf{p}D^{-1}} \cong \F_{\mf{p}}.
      \]
      Lastly, the ramification indices and inertia degrees satisfy
      \[
        e_{\mf{p}D^{-1}}(\mf{P}D^{-1}) = e_{\mf{p}}(\mf{P}) \quad \text{and} \quad f_{\mf{p}D^{-1}}(\mf{P}D^{-1}) = f_{\mf{p}}(\mf{P}).
      \]
    \end{proposition}
    \begin{proof}
      For the first statement, the identities
      \[
        \mf{P}D^{-1} \cap \smc{O}D^{-1} = \mf{p}D^{-1} \quad \text{and} \quad \mf{P} \cap \smc{O} = \mf{p},
      \]
      are equivalent by the inclusion-preserving bijections in \cref{prop:localization_prime_bijection}. Thus \(\mf{P}D^{-1}\) is above \(\mf{p}D^{-1}\) if and only if \(\mf{P}\) is above \(\mf{p}\). To prove the second statement, consider the homomorphisms
      \[
        \Phi:\mc{O} \to \F_{\mf{P}D^{-1}} \qquad \a \mapsto \a+\mf{P}D^{-1} \quad \text{and} \quad \phi:\smc{O} \to \F_{\mf{p}D^{-1}} \qquad \a \mapsto \a+\mf{p}D^{-1}.
      \]
      By the first isomorphism theorem, it suffices to show \(\Phi\) and \(\phi\) are surjective, \(\ker\Phi = \mf{P}\), and \(\ker\phi = \mf{p}\).
      
      \todo{xxx}

      Note that \(\ker\Phi = \mf{P}D^{-1} \cap \mc{O}\) and \(\ker\phi = \mf{p}D^{-1} \cap \smc{O}\). By \cref{prop:localization_prime_bijection}, we have
      \[
        \mf{P}D^{-1} \cap \mc{O} = \mf{P} \quad \text{and} \quad \mf{p}D^{-1} \cap \smc{O} = \mf{p}.
      \]
      Whence \(\ker\Phi = \mf{P}\) and \(\ker\phi = \mf{p}\). To prove the last statement, the identity
      \[
        e_{\mf{p}D^{-1}}(\mf{P}D^{-1}) = e_{\mf{p}}(\mf{P}),
      \]
      holds because the first statement implies that the prime factors of \(\mf{p}D^{-1}\mc{O}D^{-1}\) correspond to those of \(\mf{p}\mc{O}\) and hence their powers must be the same. Moreover,
      \[
        f_{\mf{p}D^{-1}}(\mf{P}D^{-1}) = f_{\mf{p}}(\mf{P}),
      \]
      by the definition of the inertia degrees and the isomorphisms in the second statement.
    \end{proof}

    The Dedekind extension \(\mc{O}/\smc{O}\) is said to be \textbf{local}\index{local} if \(\smc{O}\) is local. Equivalently, \(\smc{O}\) is a discrete valuation ring as it is a Dedekind domain. Whence \(\smc{O}\) is a principal ideal domain and \cref{thm:integral_basis_AKBL} implies that \(\mc{O}/\smc{O}\) admits an integral basis. In addition, as \(\smc{O}\) has a single prime \(\mc{O}\) has finitely many primes since they all must be above the prime of \(\smc{O}\). By \cref{prop:Dedekind_with_finite_primes_is_PID}, this forces \(\mc{O}\) to be a principal ideal domain as well. In particular, localizing the Dedekind extension \(\mc{O}/\smc{O}\) at \(\mf{p}\) produces the local Dedekind extension \(\mc{O}_{\mf{p}}/\smc{O}_{\mf{p}}\).
