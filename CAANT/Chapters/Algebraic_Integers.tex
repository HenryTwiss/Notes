\chapter{Algebraic Integers}
  ...
  \fi\section{Ramification}
    ...
    \begin{proof}
      ...
      \]
      We have \(\ker\phi = \mf{P} \cap \smc{O}\) and thus \(\ker\phi = \mf{p}\) by the previous identity. The first isomorphism theorem implies that \(\phi\) induces an injection \(\F_{\mf{p}} \to \F_{\mf{P}}\). This means \(\F_{\mf{P}}\) is a \(\F_{\mf{p}}\)-vector space of dimension at most \(n\) as \(\mc{O}\) is a finitely generated \(\smc{O}\)-module of rank at most \(n\). In other words, \(\F_{\mf{P}}/\F_{\mf{p}}\) is a field extension of degree at most \(n\).
    \end{proof}
    ...
    Suppose \(\wtilde{\mc{O}}/\mc{O}/\smc{O}\) be a tower of Dedekind extensions for finite separable tower \(M/L/K\). Let \(\wtilde{\mf{P}}\), \(\mf{P}\), and \(\mf{p}\) be primes of \(\wtilde{\mc{O}}\), \(\mc{O}\), and \(\smc{O}\) respectively with \(\wtilde{\mf{P}}\) above \(\mf{P}\) and \(\mf{P}\) above \(\mf{p}\). We illustrate this relationship via the diagram
    \begin{center}
      ...
      \end{tikzcd}
    \end{center} 
    Then \(\mf{P}^{e_{\mf{p}}(\mf{P})} \mid\mid \mf{p}\mc{O}\) and \(\mf{P}^{e_{\mf{P}}(\wtilde{\mf{P}})} \mid\mid \mf{P}\wtilde{\mc{O}}\). We also have the residue class field extensions \(\F_{\wtilde{\mf{P}}}/\F_{\mf{P}}\) and \(\F_{\mf{P}}/\F_{\mf{p}}\). It follows that
    \begin{equation}\label{equ:ramification_and_interia_towers}
      e_{\mf{p}}(\wtilde{\mf{P}}) = e_{\mf{p}}(\mf{P})e_{\mf{P}}(\wtilde{\mf{P}}) \quad \text{and} \quad f_{\mf{p}}(\wtilde{\mf{P}}) = f_{\mf{p}}(\mf{P})f_{\mf{P}}(\wtilde{\mf{P}}).
    \end{equation}
    ...
    Another way to phrase this result is that the primes above \(\mf{p}\) are all conjugate to each other and their ramification indices and inertia degrees are all equal. We call the common inertia degree \(f\) the \textbf{inertia degree}\index{inertia degree} of \(\mf{p}\) and the common ramification index \(e\) the \textbf{ramification index}\index{ramification index} of \(\mf{p}\). If there are \(r\) primes above \(\mf{p}\), the fundamental equality takes the particularly simple form
    \[
      n = ref.
    \]

    We define the \textbf{decomposition group}\index{decomposition group} \(D_{\mf{P}}\) of \(\mf{P}\) is defined to by
    \[
      D_{\mf{P}} = \{\tau \in \Gal(L/K):\tau(\mf{P}) = \mf{P}\}.
    \]
    Equivalently, the decomposition group is the stabilizer subgroup of \(\mf{P}\) in the Galois group. The associated \textbf{decomposition field}\index{decomposition field} \(L^{D_{\mf{P}}}\) of \(\mf{P}\) is defined by
    \[
      L^{D_{\mf{P}}} = \{\l \in L:\tau(\l) = \l \text{ for all } \tau \in D_{\mf{P}}\}.
    \]
    In other words, the decomposition field of \(\mf{P}\) is the fixed field of \(L\) by the decomposition group of \(\mf{P}\) and hence an intermediate field of \(L/K\). In this case, the fundamental theorem of Galois theory says
    \[
      \Gal(L/L^{D_{\mf{P}}}) = D_{\mf{P}}.
    \]
    We let \(\mc{O}^{D_{\mf{P}}}\) denote the integral closure of \(\smc{O}\) in \(L^{D_{\mf{P}}}\). Then \cref{prop:integral_closure_is_transitive,prop:integral_closure_of_Dedekind_is_Dedekind} together imply that \(\mc{O}/\mc{O}^{D_{\mf{P}}}/\smc{O}\) is a tower of Dedekind extensions for \(L/L^{D_{\mf{P}}}/K\). Also, we will write \(\mf{P}^{D}\) for the prime of \(L^{D_{\mf{P}}}\) below \(\mf{P}\). We illustrate this relationship via the diagram
    
    \begin{center}
      \begin{tikzcd}[row sep=large, column sep=large]
        \mf{P} \subset \mc{O} \subseteq L \arrow[dash]{d} \\
        \mf{P}^{D} \subset \mc{O}^{D} \subseteq L^{D_{\mf{P}}} \arrow[dash]{d} \\
        \mf{p} \subset \smc{O} \subseteq K.
      \end{tikzcd}
    \end{center}

    \iffalse
    Any of the decomposition groups \(D_{\mf{P}}\) encode how \(\mf{p}\mc{O}\) splits into distinct prime factors in \(\mc{O}\). Indeed, by the orbit-stabilizer theorem the number of cosets in \(\Gal(L/K)/D_{\mf{P}}\) is equal to the size of the orbit of \(\mf{P}\) under the action of \(\Gal(L/K)\). As the action is transitive by \cref{prop:Galois_action_on_primes_is_transitive}, \(\s(\mf{P})\) runs over the primes above \(\mf{p}\) as \(\s\) runs over a complete set of representatives for this coset space. It follows that the number of prime factors of \(\mf{p}\mc{O}\) is equal to the index \(|\Gal(L/K)/D_{\mf{P}}|\). In particular, \(\mf{p}\) is inert in \(\mc{O}/\smc{O}\) if and only if \(D_{\mf{P}} = \Gal(L/K)\) which is equivalent to \(L^{D_{\mf{P}}} = K\). Antithetically, \(\mf{p}\) is totally split in \(\mc{O}/\smc{O}\) if and only if \(D_{\mf{P}} = \{\id\}\) which is equivalent to \(L^{D_{\mf{P}}} = L\). More generally, the fundamental equality implies \(n = ef|\Gal(L/K)/D_{\mf{P}}|\) which is to say that
    \begin{equation}\label{equ:decomposition_group_e_f_relation}
      |D_{\mf{P}}| = ef.
    \end{equation}
    Then \(L/L^{D_{\mf{P}}}\) has degree \(ef\) and \(L^{D_{\mf{P}}}/K\) has degree equal to the number of distinct prime factors of \(\mf{p}\mc{O}\) which is \(|\Gal(L/K)/D_{\mf{P}}|\). If \(\mf{p}\) inert in \(\mc{O}/\smc{O}\) then \(n = ef\) implying \(e = 1\) and \(n = f\) as we have seen. If \(\mf{p}\) is totally split in \(\mc{O}/\smc{O}\) then \(1 = ef\) so that \(e = f = 1\) as we have also seen. Moreover, the decomposition group of a conjugate prime \(\s(\mf{P})\) to \(\mf{P}\) is the conjugate of decomposition group of \(\mf{P}\) by \(\s\). In other words,
    \[
      D_{\mf{p}}(\s(\mf{P})) = \s D_{\mf{P}}\s^{-1}.
    \]
    ...
    \[
      \mf{p}\mc{O} = \left(\prod_{\s \in \Gal(L/K)/D_{\mf{P}}}\s(\mf{P})\right)^{e}.
    \]
    ...
    \begin{proof}
      ...
      \begin{enumerate}[label*=(\roman*)]
        \item By the fundamental theorem of Galois theory, \(\Gal(L/L^{D_{\mf{P}}}) = D_{\mf{P}}\). It follows from \cref{prop:Galois_action_on_primes_is_transitive} that the primes of \(\mc{O}\) above \(\mf{P}^{D}\) are of the form \(\s(\mf{P})\) for \(\s \in D_{\mf{P}}\). But for these \(\s\) we have \(\s(\mf{P}) = \mf{P}\). Therefore \(\mf{P}^{D}\) is inert \(\mc{O}/\mc{O}^{D}\). This proves (i).
        \item Recall \(\Gal(L/L^{D_{\mf{P}}}) = D_{\mf{P}}\) by the fundamental theorem of Galois theory. On the one hand, since \(|\Gal(L/L^{D_{\mf{P}}})|\) is the degree of \(L/L^{D_{\mf{P}}}\) and \(\mf{P}^{D}\) is inert in \(\mc{O}/\mc{O}^{D}\), the fundamental equality gives \(|D_{\mf{P}}| = e_{\mf{P}^{D}}(\mf{P})f_{\mf{P}^{D}}(\mf{P})\). Then \cref{equ:decomposition_group_e_f_relation} gives
        \[
    ...
    \]
    Then \(I_{\mf{p}}(\mf{P})\) is a normal subgroup of \(D_{\mf{P}}\). The associated \textbf{inertia field}\index{inertia field} \(L^{I_{\mf{p}}(\mf{P})}\) of \(\mf{P}\) is defined to be
    \[
    ...
    \]
    Since \(I_{\mf{p}}(\mf{P})\) is a subgroup of \(D_{\mf{P}}\), the fundamental theorem of Galois theory implies that \(L^{I_{\mf{p}}(\mf{P})}\) is an intermediate field of \(L/L^{D_{\mf{P}}}\). We let \(\mc{O}^{I}\) denote the integral closure of \(\smc{O}\) in \(L^{I_{\mf{p}}(\mf{P})}\) so that \(\mc{O}/\mc{O}^{I}/\mc{O}^{D}\) is a tower of Dedekind extensions. Also, we will write \(\mf{P}^{I}\) for the prime of \(L^{I_{\mf{p}}(\mf{P})}\) below \(\mf{P}\). Then we can illustrate this relationship via the following tower of extensions:
    
    \begin{center}
      \begin{tikzcd}[row sep=large, column sep=large]
        \mf{P} \subset \mc{O} \subseteq L \arrow[dash]{d} \\
        \mf{P}^{I} \subset \mc{O}^{I} \subseteq L^{I_{\mf{p}}(\mf{P})} \arrow[dash]{d} \\
        \mf{P}^{D} \subset \mc{O}^{D} \subseteq L^{D_{\mf{P}}}.
      \end{tikzcd}
    \end{center}

    The inertia group \(I_{\mf{p}}(\mf{P})\) is closely related to the automorphism group of the residue class extension \(\F_{\mf{P}}/\F_{\mf{p}}\). To see this, first recall that \(\Gal(L/L^{D_{\mf{P}}}) = D_{\mf{P}}\) by the fundamental theorem of Galois theory. Then \(I_{\mf{p}}(\mf{P})\) is a normal subgroup of \(\Gal(L/L^{D_{\mf{P}}})\) and the fundamental theorem of Galois theory again implies \(L^{I_{\mf{p}}(\mf{P})}/L^{D_{\mf{P}}}\) is Galois with
    \[
      \Gal(L^{I_{\mf{p}}(\mf{P})}/L^{D_{\mf{P}}}) \cong D_{\mf{P}}/I_{\mf{p}}(\mf{P}).
    \]
    Since \(T_{\mf{p}}^{\mf{P}}\) is surjective by \cref{prop:T_map_is_surjective}, the first isomorphism theorem induces an isomorphism
    \[
      \Gal(L^{I_{\mf{p}}(\mf{P})}/L^{D_{\mf{P}}}) \cong \Aut(\F_{\mf{P}}/\F_{\mf{p}}).
    \]
    ...
    \begin{equation}\label{equ:inertia_group_e_f_relation}
      |\Gal(L^{I_{\mf{p}}(\mf{P})}/L^{D_{\mf{P}}})| = f \quad \text{and} \quad |I_{\mf{p}}(\mf{P})| = e.
    \end{equation}
    Then \(L^{I_{\mf{p}}(\mf{P})}/L^{D_{\mf{P}}}\) has degree \(f\) and \(L/L^{I_{\mf{p}}(\mf{P})}\) has degree \(e\). The decomposition and inertia groups fit into the follow exact sequence
    ...
    \begin{proposition}\label{prop:inertia_group_exact_sequence}
      ...
      \begin{center}
        \begin{tikzcd}[row sep=large, column sep=large]
          1 \arrow{r} & I_{\mf{p}}(\mf{P}) \arrow{r} & D_{\mf{P}} \arrow{r}{T_{\mf{p}}^{\mf{P}}} & \Aut(\F_{\mf{P}}/\F_{\mf{p}}) \arrow{r} & 1,
        \end{tikzcd}
      \end{center}
      is exact.
    \end{proposition}
    \begin{proof}
      The sequence is exact at \(I_{\mf{p}}(\mf{P})\) because the second map is injective. Exactness at \(D_{\mf{P}}\) follows by the definition of \(I_{\mf{p}}(\mf{P})\). Lastly, we have exactness at \(\Aut(\F_{\mf{P}}/\F_{\mf{p}})\) since \(T_{\mf{p}}^{\mf{P}}\) is surjective by \cref{prop:T_map_is_surjective}.
    \end{proof}
