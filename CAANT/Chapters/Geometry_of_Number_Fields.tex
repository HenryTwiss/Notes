\chapter{Geometry of Number Fields}
  ...
  \section{\todo{Minkowski Space}}
    ...
    \]
    In other words, the canonical embedding is just the diagonal embedding of \(K\) into \(\conj{\Q}\) via \(\Q\)-embeddings. In view of \cref{prop:formulas_for_trace_and_norm}, we have
    \[
    ...
    \begin{proposition}\label{prop:Minkowski_space_isomorphism}
      Let \(K\) be a number field of degree \(n\) and signature \((r_{1},r_{2})\). Then there is an isomorphism
      \[
