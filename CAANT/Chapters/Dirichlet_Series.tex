\chapter{Dirichlet Series}
  ...
  \section{Perron Formulas}
    ...
    \]
    As \(\psi(y)\) has compact support, the integral defining \(\Psi(s)\) is a locally absolutely uniformly convergent. In particular, \(\Psi(s)\) is holomorphic and Mellin inversion implies that \(\psi(y)\) is the Mellin inverse of \(\Psi(s)\). As for nice properties, \(\Psi(s)\) exhibit rapid decay.
