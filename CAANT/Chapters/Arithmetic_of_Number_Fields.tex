\chapter{Arithmetic of Number Fields}
  ...
  \section{Prime Splitting}
    ...
    \begin{proof}
      ...
      \[
        \mc{O}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})} \supset \mf{P}_{i}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})} \supset \cdots \supset \mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})},
      \]
      of \(\F_{\mf{P}_{i}}\)-vector subspaces. By the third isomorphism theorem, quotients of successive subspaces of the filtration are isomorphic to \(\mf{P}_{i}^{j}/\mf{P}_{i}^{j+1}\). As every vector subspace has a complement, iteratively applying this isomorphism shows
      \[
        \mc{O}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})} \cong \bigop_{j}\mf{P}_{i}^{j}/\mf{P}_{i}^{j+1}.
      \]
      The summands are all isomorphic to \(\F_{\mf{P}_{i}}\) by \cref{lem:isomorphism_of_quotient_by_prime_integral_ideals} which is an \(\F_{\mf{p}}\)-vector space of dimension \(f_{\mf{p}}(\mf{P}_{i})\). It follows that \(\mc{O}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(e_{\mf{p}}(\mf{P}_{i})f_{\mf{p}}(\mf{P_{i}})\).
    \end{proof}
    ...
    \subsection*{Number Fields}
      ...
      \begin{proof}
        ...
        \[
          \mc{O}_{K}/\mf{p}^{e} \supset \mf{p}/\mf{p}^{e} \supset \cdots \supset \mf{p}^{e}/\mf{p}^{e},
        \]
        of \(\F_{p}\)-vector subspaces. By the third isomorphism theorem, quotients of successive subspaces of the filtration are isomorphic to \(\mf{p}^{i}/\mf{p}^{i+1}\). As every vector subspace has a complement, iteratively applying this isomorphism shows
        \[
          \mc{O}_{K}/\mf{p}^{e} \cong \bigop_{i}\mf{p}^{i}/\mf{p}^{i+1}.
        \]
        Therefore
        \[
          |\mc{O}_{K}/\mf{p}^{e}| = \prod_{i}|\mf{p}^{i}/\mf{p}^{i+1}|.
        \]
        Each factor is isomorphic to \(\F_{\mf{p}}\) by \cref{lem:isomorphism_of_quotient_by_prime_integral_ideals}. As \(\F_{\mf{p}}\) is an \(\F_{p}\)-vector space of dimension \(f_{p}(\mf{p})\), we find that \(|\mf{p}^{i}/\mf{p}^{i+1}| = p^{f_{p}(\mf{p})}\). Whence \(|\mc{O}_{K}/\mf{p}^{e}| = p^{ef_{p}(\mf{p})}\). This proves the first statement. The second statement follows from the first together with \cref{prop:ideal_norm_of_principal_ideal}.
      \end{proof}
  ...
  \section{Differents and Discriminants}
    ...
    \begin{proof}
      ...
      To prove \(\mf{P}^{e_{\mf{p}}(\mf{P})-1} \mid \mf{D}_{\mc{O}/\smc{O}}\), take \(e = e_{\mf{p}}(\mf{P})-1\) so that \(\mf{P} \mid\mid \mf{A}\). Then the prime factors of \(\mf{A}\) and \(\mf{p}\mc{O}\) are the same. Whence there is a positive integer \(k\) such that \(\mf{A}^{k}\) is divisible by \(\mf{p}\mc{O}\). So \(\mf{p}\mc{O} \mid \mf{A}^{k}\) and therefore \(\mf{A}^{k} \subseteq \mf{p}\mc{O}\) as to divide is to contain. It follows that the \(k\)-th power of the \(\F_{\mf{p}}\)-linear operator on \(\mc{O}/\mf{p}\mc{O}\) for any class of \(\mf{A}/\mf{p}\mc{O}\) is the zero operator. Such an operator is necessarily nilpotent. As nilpotent operators have trace zero, \(\Trace_{(\mc{O}/\mf{p}\mc{O})/\F_{\mf{p}}}(\mf{A}/\mf{p}\mc{O}) = 0\) which is stronger than the desired congruence. This proves the first statement.
      ...
      \[
        \mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})} \supset \mf{P}/\mf{P}^{e_{\mf{p}}(\mf{P})} \supset \cdots \supset \mf{P}^{e_{\mf{p}}(\mf{P})}/\mf{P}^{e_{\mf{p}}(\mf{P})},
      \]
      of \(\F_{\mf{p}}\)-vector subspaces. By the third isomorphism theorem, quotients of successive subspaces of the filtration are isomorphic to \(\mf{P}^{i}/\mf{P}^{i+1}\) which is induced by natural projection. As every vector subspace has a complement, iteratively applying this isomorphism shows
      \[
        \mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})} \cong \bigop_{i}\mf{P}^{i}/\mf{P}^{i+1}.
      \]
      Whence
      \[
        \Trace_{(\mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})})/\F_{\mf{p}}}(\mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})}) = \sum_{i}\Trace_{(\mf{P}^{i}/\mf{P}^{i+1})/\F_{\mf{p}}}(\mf{P}^{i}/\mf{P}^{i+1}).
      \]
      By \cref{lem:isomorphism_of_quotient_by_prime_integral_ideals}, every quotient \(\mf{P}^{i}/\mf{P}^{i+1}\) is isomorphic to \(\F_{\mf{P}}\) which is induced by multiplication and natural projection. This implies the the trace in the summands are all \(\Trace_{\F_{\mf{P}}/\F_{\mf{p}}}(\F_{\mf{P}})\). So
      \[
        \Trace_{(\mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})})/\F_{\mf{p}}}(\mc{O}/\mf{P}^{e_{\mf{p}}(\mf{P})}) = e_{\mf{p}}(\mf{P})\Trace_{\F_{\mf{P}}/\F_{\mf{p}}}(\F_{\mf{P}}).
      \]
