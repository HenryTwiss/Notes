\chapter{Arithmetic of Number Fields}
  ...
  \section{Localization}
    ...
    \[
      \k = \e\pi^{n},
    \]
    for some integer \(n\) and unit \(\e\). The most important data of a discrete valuation ring is its valuation. The \textbf{valuation}\index{valuation} \(v\) associated to \(\smc{O}\) is the function defined by
    \[
  ...
  \section{Prime Splitting}
    ...
    \]
    That is, \(f_{\mf{p}}(\mf{P})\) is the degree of \(\F_{\mf{P}}/\F_{\mf{p}}\) which is the dimension of the residue field \(\F_{\mf{P}}\) as an \(\F_{\mf{p}}\)-vector space. In fact, something slightly more general is true. Let \(\mf{A}\) be an integral ideal of \(\mc{O}\) containing \(\mf{p}\). Consider the homomorphism
    \[
      \phi:\smc{O} \to \mc{O}/\mf{A} \qquad \a \mapsto \a+\mf{A},
    \]
    induced by natural projection. As \(\mf{p} \subseteq \mf{A}\), we have that \(\ker\phi = \mf{A} \cap \smc{O}\) contains \(\mf{p}\). So \(\phi\) induces a homomorphism \(\F_{\mf{p}} \to \mc{O}/\mf{A}\). Whence \(\mc{O}/\mf{A}\) is a finite dimensional \(\F_{\mf{p}}\)-vector space of dimension at most \(n\) because \(\mc{O}\) is a finitely generated \(\smc{O}\)-module of rank at most \(n\). We obtain the residue class extension when \(\mf{A} = \mf{P}\).
    ...
    \begin{lemma}\label{lem:quotient_by_prime_power_isomorphism}
      ...
      \[
        \mc{O}/\mf{P}^{e} \cong \bigop^{e}\F_{\mf{P}}.
      \]
      In particular, the dimension of \(\mc{O}/\mf{P}^{e}\) as an \(\F_{\mf{p}}\)-vector space is \(ef_{\mf{p}}(\mf{P})\).
    \end{lemma}
    \begin{proof}
      ...
      \[
        \mc{O}/\mf{P}^{e} \cong \bigop^{e}\F_{\mf{P}}.
      \]
      This proves the first statement. Since the dimension of \(\F_{\mf{P}}\) as an \(\F_{\mf{p}}\)-vector space is \(f_{\mf{p}}(\mf{P})\) by definition, it follows that \(\mc{O}/\mf{P}^{e}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(ef_{\mf{p}}(\mf{P})\). This proves the second statement.
    \end{proof}
    
    We can now describe the relationship between ramification indices and inertia degrees. The idea is that \(\mc{O}/\mf{p}\mc{O}\) is of maximum dimension as an \(\F_{\mf{p}}\)-vector space, namely \(n\), and its dimension can be computed as a sum of products of the ramification indices and inertia degrees. This relationship is known as the \textbf{fundamental equality}\index{fundamental equality}.
    ...
    \begin{proof}
      ...
      \]
      Hence \(\l_{1},\ldots,\l_{m}\) spans \(L/K\) whence \(\mc{O}/\mf{p}\mc{O}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(n\). For \(\mc{O}/\mf{P}_{i}^{e_{\mf{p}}(\mf{P}_{i})}\), the dimensionality claim follows from \cref{lem:quotient_by_prime_power_isomorphism}. So our dimension computations combine to give
      \[
        n = \sum_{i}e_{\mf{p}}(\mf{P}_{i})f_{\mf{p}}(\mf{P}_{i}).
      \]
    \end{proof}
    ...
    \end{proposition}
    \begin{proof}
      In view of \cref{prop:ring_is_intersection_of_all_localizations,prop:ideal_norm_localization_is_localization_of_ideal_norm}, we may assume that \(\mc{O}/\smc{O}\) is a local Dedekind extension. Moreover, as \(\mf{N}_{\mc{O}/\smc{O}}\) and \(\Norm_{L/K}\) are both completely multiplicative and \(L\) is the field of fractions of \(\mc{O}\), it is enough to prove the claim when \(\l \in \mc{O}\). By prime factorization, we may write
      \[
        \l\mc{O} = \prod_{\mf{P} \mid \mf{p}\mc{O}}\mf{P}^{v_{\mf{P}}(\l)},
      \]
      since every prime \(\mf{P}\) of \(\mc{O}\) is above the unique prime \(\mf{p}\) of \(\smc{O}\). Whence
      \[
        \mf{N}_{\mc{O}/\smc{O}}(\l\mc{O}) = \prod_{\mf{P} \mid \mf{p}\mc{O}}\mf{p}^{v_{\mf{P}}(\l)f_{\mf{p}}(\mf{P})} \quad \text{and} \quad \Norm_{L/K}(\l)\smc{O} = \mf{p}^{v_{\mf{p}}(\Norm_{L/K}(\l))},
      \]
      and we are reduced to proving
      \[
        \sum_{\mf{P} \mid \mf{p}\mc{O}}v_{\mf{P}}(\l)f_{\mf{p}}(\mf{P}) = v_{\mf{p}}(\Norm_{L/K}(\l)).
      \]
      We will show this by computing the dimension of \(\mc{O}/\smc{O}\) as an \(\F_{\mf{p}}\)-vector space in two ways. First, the Chinese remainder theorem gives an isomorphism
      \[
        \mc{O}/\smc{O} \cong \bigop_{\mf{P} \mid \mf{p}\mc{O}}\mc{O}/\mf{P}^{v_{\mf{P}}(\l)}.
      \]
      By \cref{lem:quotient_by_prime_power_isomorphism}, \(\mc{O}/\mf{P}^{v_{\mf{P}}(\l)}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(v_{\mf{P}}(\l)f_{\mf{p}}(\mf{P})\). Therefore \(\mc{O}/\smc{O}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(\sum_{\mf{P} \mid \mf{p}\mc{O}}v_{\mf{P}}(\l)f_{\mf{p}}(\mf{P})\). On the other hand, \(\mc{O}\) is a free \(\smc{O}\)-module of rank \(n\) as \(\mc{O}/\smc{O}\) admits an integral basis. By the structure theorem for finitely generated modules over principal ideal domains and \cref{thm:integral_basis_AKBL}, we have isomorphisms
      \[
        \mc{O} \cong \bigop^{n}\smc{O} \quad \text{and} \quad \l\mc{O} \cong \bigop_{i}\pi^{k_{i}}\smc{O},
      \]
      for some nonnegative integers \(k_{1},\ldots,k_{n}\) and where \(\pi\) is a uniformizer for \(\smc{O}\). Whence there is another isomorphism
      \[
        \mc{O}/\smc{O} \cong \bigop_{i}\smc{O}/\pi^{k_{i}}\smc{O}.
      \]
      Moreover, \(\Norm_{L/K}(\l) = \Norm_{\mc{O}/\smc{O}}(\l)\) by \cref{prop:trace_and_norm_reduce_for_integral_basis}. Recall that \(\Norm_{\mc{O}/\smc{O}}(\l)\) is the determinant of the \(\smc{O}\)-linear operator
      \[
        T_{\l}:\mc{O} \to \mc{O} \qquad x \mapsto \l x. 
      \]
      So under the aforementioned isomorphisms, it follows that \(\Norm_{\mc{O}/\smc{O}}(\l) = \pi^{\sum_{i}k_{i}}\) whence \(v_{\mf{p}}(\Norm_{L/K}(\l)) = \sum_{i}k_{i}\). The proof will be complete if the dimension of \(\mc{O}/\smc{O}\) as an \(\F_{\mf{p}}\)-vector space is \(\sum_{i}k_{i}\). From \cref{lem:quotient_by_prime_power_isomorphism} we see that \(\smc{O}/\pi^{k_{i}}\smc{O}\) is an \(\F_{\mf{p}}\)-vector space of dimension \(k_{i}\). The claim follows from the last isomorphism above.
    \end{proof}
    ...
    \subsection*{Number Fields}
      ...
      \end{proposition}
      \begin{proof}
        By prime factorization, we may write
        \[
          \mf{a} = \prod_{\mf{p}}\mf{p}^{e_{\mf{p}}},
        \]
        where all but finitely many of the nonnegative integers \(e_{\mf{p}}\) are zero. As the Chinese remainder theorem gives an isomorphism
        \[
          \mc{O}_{K}/\mf{a} \cong \bigop_{\mf{p}}\mc{O}_{K}/\mf{p}^{e_{\mf{p}}}\mc{O}_{K},
        \]
        it suffices to prove the claim for \(\mf{p}^{e_{\mf{p}}}\). Fix a prime \(\mf{p}\) and let \(p\) be the prime below it. On the one hand, \(\Norm_{K}(\mf{p}^{e}) = p^{ef_{p}(\mf{p})}\). On the other hand, \cref{lem:quotient_by_prime_power_isomorphism} shows that \(\mc{O}_{K}/\mf{p}^{e}\) is an \(\F_{p}\)-vector space of dimension \(ef_{p}(\mf{p})\) whence \(|\mc{O}_{K}/\mf{p}^{e}| = p^{ef_{p}(\mf{p})}\). So
        \[
          \Norm_{K}(\mf{p}^{e}) = |\mc{O}_{K}/\mf{p}^{e}|,
        \]
        proving the first statement. The second statement follows from \cref{prop:ideal_norm_of_principal_ideal}.
      \end{proof}
  ...
  \section{Differents and Discriminants}
    ...
    \begin{theorem}\label{thm:ramifies_if_and_only_if_divides_the_different}
      Let \(\mc{O}/\smc{O}\) be a Dedekind extension of a degree \(n\) separable extension \(L/K\) and assume that all residue class extensions are separable. Then a prime \(\mf{P}\) of \(\mc{O}\) ramifies in \(\mc{O}/\smc{O}\) if and only if \(\mf{P}\) divides \(\mf{D}_{\mc{O}/\smc{O}}\). In particular, if \(\mf{P}\) is above \(\mf{p}\) then the following divisibility properties hold:
      \begin{enumerate}[label*=(\roman*)]
    ...
    \end{theorem}
    \begin{proof}
      As all residue class extensions are separable by assumption, \(\mf{P}\) ramifies in \(\mc{O}/\smc{O}\) if and only if \(e_{\mf{p}}(\mf{P}) \ge 2\). But properties (i) and (ii) together imply that \(\mf{P} \mid \mf{D}_{\mc{O}/\smc{O}}\) if and only if \(e_{\mf{p}}(\mf{P}) \ge 2\). Whence \(\mf{P}\) ramifies in \(\mc{O}/\smc{O}\) if and only if \(\mf{P} \mid \mf{D}_{\mc{O}/\smc{O}}\). So it remains to prove properties (i) and (ii).

      In view of \cref{prop:ring_is_intersection_of_all_localizations,prop:ramification_setup_respects_localization,prop:different_and_discriminant_respect_localization}, we may assume that \(\mc{O}/\smc{O}\) is a local Dedekind extension. We will first show the weaker condition \(\mf{P}^{e_{\mf{p}}(\mf{P})-1} \mid \mf{D}_{\mc{O}/\smc{O}}\) for any ramification index \(e_{\mf{p}}(\mf{P})\). To this end, write \(\mf{p}\mc{O} = \mf{P}^{e_{\mf{p}}(\mf{P})-1}\mf{A}\) for some integral ideal \(\mf{A}\) of \(\mc{O}\) so that \(\mf{P} \mid\mid \mf{A}\). By \cref{lem:different_containment_lemma}, \(\mf{P}^{e_{\mf{p}}(\mf{P})-1} \mid \mf{D}_{\mc{O}/\smc{O}}\) if and only if \(\Trace_{L/K}(\mf{P}^{1-e_{\mf{p}}(\mf{P})}) \subseteq \smc{O}\). As \(\mf{P}^{1-e_{\mf{p}}(\mf{P})} = \mf{p}^{-1}\mf{A}\), it it further equivalent to show \(\Trace_{L/K}(\mf{A}) \subseteq \mf{p}\). As \(\mc{O}/\smc{O}\) admits an integral basis, we have \(\Trace_{K/L}(\mf{A}) = \Trace_{\mc{O}/\smc{O}}(\mf{A})\) from  \cref{prop:trace_and_norm_reduce_for_integral_basis} and so it is further equivalent to show
      \[
        \Trace_{\mc{O}/\smc{O}}(\mf{A}) \subseteq \mf{p}.
      \]
      Let \(\a \in \mf{A}\) and let \(\conj{\a} \in \mc{O}/\mf{p}\mc{O}\) be its image under natural projection. Consider the \(\smc{O}\)-linear operator
      \[
        T_{\a}:\mc{O} \to \mc{O} \qquad x \mapsto \a x.
      \]
      Since \(\mf{p}\mc{O}\) is \(T_{\a}\)-invariant, there is an induced \(\F_{\mf{p}}\)-linear operator
      \[
        T_{\conj{\a}}:\mc{O}/\mf{p}\mc{O} \to \mc{O}/\mf{p}\mc{O} \qquad \conj{x} \mapsto \conj{\a x}.
      \]
      Recall that \(\mc{O}/\smc{O}\) admits an integral basis. The image of which in \(\mc{O}/\mf{p}\mc{O}\) under natural projection is a basis for \(\mc{O}/\mf{p}\mc{O}\) as an \(\F_{\mf{p}}\)-vector space. Whence
      \[
      ...
      \]
      By construction, the prime factors of \(\mf{A}\) and \(\mf{p}\mc{O}\) are the same. Whence there is a positive integer \(e\) such that \(\mf{A}^{e}\) is divisible by \(\mf{p}\mc{O}\). So \(\mf{p}\mc{O} \mid \mf{A}^{e}\) and therefore \(\mf{A}^{e} \subseteq \mf{p}\mc{O}\) as to divide is to contain. This implies \(T_{\conj{\a}}^{e}\) is the zero operator so that it is nilpotent. As nilpotent operators have trace zero, \(\Trace_{(\mc{O}/\mf{p}\mc{O})/\F_{\mf{p}}}(\conj{\a}) = 0\) which implies the desired congruence.
      
      \iffalse We now prove (i) and (ii):
      \begin{enumerate}[label*=(\roman*)]
