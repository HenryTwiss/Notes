\chapter{Arithmetic of Number Fields}
  ...
  \section{\todo{Orders}}
    ...
    \begin{proof}
      ...
      \]
      induced by natural projection. Since \(\conj{m_{i}}(x)\) is irreducible, \((\conj{m_{i}}(x))\) is maximal whence \(\F_{\mf{p}}[x]/(\conj{m_{i}}(x))\) is a field. By the fourth isomorphism theorem, \((\conj{m_{i}}(x))/(\conj{m_{i}}(x)^{e_{i}})\) is a maximal ideal of \(\F_{\mf{p}}[x]/(\conj{m_{i}}(x)^{e_{i}})\). So under the aforementioned isomorphism, the maximal ideals of \(\F_{\mf{p}}[x]/(\conj{m_{\t}}(x))\) are of the form \((\conj{m_{i}}(x))/(\conj{m_{\theta}}(x))\) and the corresponding quotient fields are isomorphic to \(\F_{\mf{p}}[x]/(\conj{m_{i}}(x))\) by the third isomorphism theorem. As the chain of isomorphisms previously established are induced by natural projections, the maximal ideals of \(\mc{O}/\mf{p}\mc{O}\) are of the form \(m_{i}(\t)\mc{O}/\mf{p}\mc{O}\).
      
      It is now possible to show that the \(\mf{P}_{i}\) are prime. To see this, consider the homomorphism
      \[
        \pi:\mc{O} \to \mc{O}/\mf{p}\mc{O} \qquad \a \mapsto \a+\mf{p}\mc{O},
      \]
      given by natural projection. As such, \(\pi\) is surjective. \todo{xxx}
    \end{proof}

    \iffalse
    \begin{proof}
     We now show that the \(\mf{P}_{i}\) are prime. To see this, consider the surjective homomorphism
      \[
        \pi:\mc{O} \to \mc{O}/\mf{p}\mc{O} \qquad \a \mapsto \a+\mf{p}\mc{O}.
      \]
      ...
      \[
        \F_{\mf{P}_{i}} \cong (\mc{O}/\mf{p}\mc{O})/(\conj{m_{i}(\t)}(\mc{O}/\mf{p}\mc{O})) \cong \F_{\mf{p}}[x]/(\conj{m_{i}}(x)),
      \]
      where the first isomorphism follow by taking \(\F_{\mf{P}_{i}}\) and reducing \(\mc{O}\) modulo \(\mf{p}\) and the second isomorphism follows from \(\mc{O}/\mf{p}\mc{O} \cong A\) and that the image of the maximal ideal \(\conj{m_{i}(\t)}(\mc{O}/\mf{p}\mc{O})\) under this isomorphism is \(\conj{m_{i}}(x)A\). Now \(\F_{\mf{p}}[x]/(\conj{m_{i}}(x))\) is an \(\F_{\mf{p}}\)-vector space of degree \(\deg(\conj{m_{i}}(x))\). Hence \(f_{p}(\mf{P}_{i}) = \deg(\conj{m_{i}}(x))\) for all \(i\) as desired. The ideal \(\conj{m_{i}}(x)^{e_{i}}A\) under the isomorphism \(A \cong \mc{O}/\mf{p}\mc{O}\) is the ideal \(\conj{m_{i}(\t)}^{e_{i}}(\mc{O}/\mf{p}\mc{O})\). As the image of \(\mf{P}_{i}\) under \(\pi\) is \(\conj{m_{i}(\t)}(\mc{O}/\mf{p}\mc{O})\), we have that \(\mf{P}_{i}^{e_{i}}\) is contained in the preimage of \(\conj{m_{i}(\t)}^{e_{i}}(\mc{O}/\mf{p}\mc{O})\) under \(\pi\). As \(\conj{m_{\t}(\t)}(\mc{O}/\mf{p}\mc{O}) = 0\), it follows that
      \[
