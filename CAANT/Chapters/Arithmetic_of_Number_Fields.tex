\chapter{Arithmetic of Number Fields}
  ...
  \section{Prime Splitting}
    ...
    \]
    In any case, the ideal norm is aptly named because it is compatible with the norm \(N_{L/K}\).
