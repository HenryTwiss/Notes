\chapter{Arithmetic of Number Fields}
  ...
  \section{\todo{Orders}}
    ...
    With this formulation of the Picard group, it is possible to obtain a short exact sequence relating the Picard and ideal class groups of \(\smc{O}\) and its normalization \(\conj{\smc{O}}\).
