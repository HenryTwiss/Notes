\chapter{Arithmetic of Number Fields}
  ...
  \section{Dedekind Domains}
    ...
    \begin{proposition}\label{prop:ideal_class_group_exact_sequence}
      Let \(\smc{O}\) be a Dedekind domain with field of fractions \(K\). Then there is an exact sequence
      \begin{center}
        \begin{tikzcd}
          1 \arrow{r} & \smc{O}^{\ast} \arrow{r} & K^{\ast} \arrow{r} & I(\smc{O}) \arrow{r} & \Cl(\smc{O}) \arrow{r} & 1,
        \end{tikzcd}
      \end{center}
      induced by natural inclusions and where the third map is given by \(\k \mapsto \k\smc{O}\).
    \end{proposition}
    \begin{proof}
      As the second map is injective and the fourth map is surjective, the sequence is exact at \(\smc{O}^{\ast}\) and \(\Cl(\smc{O})\). So it suffices to prove exactness at \(K^{\ast}\) and \(I(\smc{O})\). For exactness at \(K^{\ast}\), recall from \cref{thm:ideal_group_is_a_group} that \(\smc{O}\) is the identity of \(I(\smc{O})\). A principal integral ideal is \(\smc{O}\) if and only if it is generated by a unit in \(\smc{O}\) and exactness at \(K^{\ast}\) follows. We have exactness at \(I(\smc{O})\) because the principal fractional ideals represent the identity class of \(\Cl(\smc{O})\) and these are generated by elements of \(K^{\ast}\).
    \end{proof}
    ...
    \begin{proof}
      ...
      \]
      induced by natural inclusion. Then \(\ker\phi = \mf{P} \cap \smc{O}\) and we claim \(\mf{P} \cap \smc{O}\) is a prime of \(\smc{O}\). It is clearly an ideal of \(\smc{O}\) and is prime because \(\mf{P}\) is. To see that it is not the zero ideal, let \(\l \in \mf{P}\) be nonzero. As \(\l\) is integral over \(\smc{O}\), we have
      \[
  ...
  \section{Ramification}
    ...
    \begin{proposition}\label{prop:inertia_group_exact_sequence}
      Let \(\mc{O}/\smc{O}\) be a Dedekind extension of a finite Galois extension \(L/K\), let \(\mf{p}\) be a prime of \(\smc{O}\), and let \(\mf{P}\) be a prime of \(\mc{O}\) above \(\mf{p}\). Then there is an exact sequence
      \begin{center}
        \begin{tikzcd}
          1 \arrow{r} & I_{\mf{p}}(\mf{P}) \arrow{r} & D_{\mf{p}}(\mf{P}) \arrow{r} & \Aut(\F_{\mf{P}}/\F_{\mf{p}}) \arrow{r} & 1,
        \end{tikzcd}
      \end{center}
      induced by natural inclusions and where the third map is given by \(\tau \mapsto T_{\mf{p}}^{\mf{P}}(\tau)\).
    \end{proposition}
    \begin{proof}
  ...
  \section{Localization}
    ...
    The relationship between \(\smc{O}\) and \(\smc{O}(X)\) can be expressed via an exact sequence.
     ...
     \begin{proposition}\label{prop:ideal_class_group_localization_exact_sequence}
      Let \(\smc{O}\) be a Dedekind domain with field of fractions \(K\) and let \(X\) be a set of all but finitely many primes of \(\smc{O}\). Then there is an exact sequence
      \begin{center}
        \begin{tikzcd}
  ...
  \section{\todo{Orders}}
    ...
    Accordingly, an \textbf{order}\index{order} \(\smc{O}\) is a one-dimensional noetherian domain whose conductor is an integral ideal of \(\smc{O}\). If \(\smc{O}\) has field of fractions \(K\), then this last condition is equivalent to \(\conj{\smc{O}}\) being a finitely generated \(\smc{O}\)-module. This means \(\smc{O}\) is a Dedekind domain if and only if it is integrally closed which happens if and only if the conductor is \(\smc{O}\) itself. In fact, the normalization of an order is always a Dedekind domain.
    ...
    \begin{proposition}\label{prop:localized_Chinese_remainder_theorem}
      Let \(\smc{O}\) be an order. Then for any integral ideal \(\mf{a}\) of \(\smc{O}\), we have an isomorphism
      \[
        \smc{O}/\mf{a} \cong \bigop_{\mf{p}}\smc{O}_{\mf{p}}/\mf{a}_{\mf{p}},
      \]
      induced by natural inclusion. In particular, \(\mf{a}_{\mf{p}} = \smc{O}_{\mf{p}}\) for all but finitely many primes \(\mf{p}\) those of which satisfy \(\mf{a} \subseteq \mf{p}\) and so this isomorphism can be expressed as
      \[
    ...
    \begin{proof}
      ...
      \]
      induced by natural inclusion. As \(\wtilde{\mf{a}}_{\mf{p}} = \smc{O}\) unless \(\mf{a} \subseteq \mf{p}\), this isomorphism can be expressed as
      \[
        \smc{O}/\mf{a} \cong \bigop_{\mf{a} \subseteq \mf{p}}\smc{O}/\wtilde{\mf{a}}_{\mf{p}}.
      \]
       It remains to demonstrate that natural inclusion induces an isomorphism \(\smc{O}/\wtilde{\mf{a}}_{\mf{p}} \cong \smc{O}_{\mf{p}}/\mf{a}_{\mf{p}}\). To see this, consider the homomorphism
      \[
        \phi:\smc{O} \to \smc{O}_{\mf{p}}/\mf{a}_{\mf{p}} \qquad \a \mapsto \a+\mf{a}_{\mf{p}},
      \]
      induced by natural inclusion. By the first isomorphism theorem, it suffices to show \(\phi\) is surjective and \(\ker\phi = \wtilde{\mf{a}}_{\mf{p}}\). As \(\smc{O}_{\mf{p}}\) is local with unique maximal ideal \(\mf{p}_{\mf{p}}\), \(\smc{O}_{\mf{p}}/\mf{a}_{\mf{p}}\) has a unique maximal ideal \(\mf{p}_{\mf{p}}/\mf{a}_{\mf{p}}\) by the fourth isomorphism theorem. Whence
      \[
    ...
    The Picard group of \(\smc{O}\) and the ideal class group of \(\conj{\smc{O}}\) fit into an exact sequence.
    
    \begin{proposition}
      Let \(\smc{O}\) be an order with field of fractions \(K\). Then there is an exact sequence
      \begin{center}
        \begin{tikzcd}
          1 \arrow{r} & \smc{O}^{\ast} \arrow{r} & \conj{\smc{O}}^{\ast} \arrow{r} & \displaystyle{\bigop_{\mf{p}}\conj{\smc{O}}_{\mf{p}}^{\ast}/\smc{O}_{\mf{p}}^{\ast}} \arrow{r} & \Pic(\smc{O}) \arrow{r} & \Cl(\smc{O}) \arrow{r} & 1,
        \end{tikzcd}
      \end{center}
      induced by natural inclusions and where the fourth map is induced by \((\e_{\mf{p}})_{\mf{p}}\mapsto \prod_{\mf{p}}\e_{\mf{p}}\smc{O}\).
    \end{proposition}
    \begin{proof}
      \todo{xxx}
    \end{proof}
