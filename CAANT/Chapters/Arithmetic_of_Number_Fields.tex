\chapter{Arithmetic of Number Fields}
  ...
  \fi\iffalse\section{\todo{The Ideal Norm}}
    ...
    \[
      \mf{F} = \mf{P}_{1}^{e_{1}} \cdots \mf{P}_{r}^{e_{r}}.
    \]
    Let \(\mf{p}_{i}\) be the prime below \(\mf{P}_{i}\). We define the \textbf{norm}\index{norm} \(\Norm_{\mc{O}/\smc{O}}(\mf{F})\) of \(\mf{F}\) by
    \[
      \Norm_{\mc{O}/\smc{O}}(\mf{F}) = \mf{p}_{1}^{e_{1}f_{\mf{p}_{1}}(\mf{P}_{1})} \cdots \mf{p}_{r}^{e_{r}f_{\mf{p}_{r}}(\mf{P}_{r})}.
    \]
    Setting \(\Norm_{\mc{O}/\smc{O}}(\mc{O}) = \smc{O}\), unique factorization shows that we obtain a homomorphism
    \[
      \Norm_{\mc{O}/\smc{O}}:I(\mc{O}) \to I(\smc{O}) \qquad \mf{P}_{1}^{e_{1}} \cdots \mf{P}_{r}^{e_{r}} \mapsto \mf{p}_{1}^{e_{1}f_{\mf{p}_{1}}(\mf{P}_{1})} \cdots \mf{p}_{r}^{e_{r}f_{\mf{p}_{r}}(\mf{P}_{r})},
    \]
    ...
    \[
      \Norm_{\mc{O}/\smc{O}}(\mf{p}\mc{O}) = \mf{p}^{n},
    \]
    ...
    \begin{proposition}
      ...
      \[
        \Norm(\l\mc{O}) = \Norm_{L/K}(\l)\smc{O},
      \]
      for any \(\l \in L\).
    \end{proposition}
    \begin{proof}
      In view of \cref{prop:ring_is_intersection_of_all_localizations}, it suffices to show
      \[
        \Norm(\l\mc{O})_{\mf{p}} = \Norm_{L/K}(\l)\smc{O}_{\mf{p}},
      \]
      ...
      \[
        \Norm(\l\mc{O})_{\mf{p}} = \mf{p}_{\mf{p}}^{\sum_{\mf{P}_{i} \mid \mf{p}\mc{O}}e_{i}f_{\mf{p}}(\mf{P}_{i})}.
      \]
