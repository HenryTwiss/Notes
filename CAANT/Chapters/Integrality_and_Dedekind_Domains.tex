\chapter{Integrality and Dedekind Domains}
  ...
  \section{Dedekind Domains}
    ...
    With the prime factorization in hand, we will discuss the group structure of the fractional ideals of \(\smc{O}\). Let \(I_{\smc{O}}\) denote the set of fractional ideals of \(\smc{O}\). This is indeed an abelian group.
    ...
    Let \(P_{\smc{O}}\) denote the subgroup of principal fractional ideals of \(I_{\smc{O}}\). Since \(I_{\smc{O}}\) is abelian by the previous result, \(P_{\smc{O}}\) is normal. The \textbf{ideal class group}\index{ideal class group} \(\Cl(\smc{O})\) of \(\smc{O}\) is defined to be the quotient
    \[
    ...
    Thinking of the third map in this exact sequence as passing from numbers in \(K^{\ast}\) to fractional ideals in \(I_{\smc{O}}\), exactness means that unit group is measuring the contraction (how many numbers are annihilated) taking place during this process while the ideal class group is measuring the expansion (how many fractional ideals are created).
  ...
  \section{\todo{Orders}}
    ...
    There is a generalization of the ideal class group to orders as well. Since \(\mf{o}\) is not necessarily a Dedekind domain, fractional ideals need not be invertible. The natural restriction is to then consider all fractional ideals which are invertible. Let \(I_{\mf{o}}\) denote the set of invertible fractional ideals of \(\mf{o}\) which are invertible. Then it is easy to see that this is an abelian group.

    \begin{theorem}\label{thm:order_ideal_group_is_a_group}
      Let \(\mc{O}/\smc{O}\) be a Dedekind extension for a degree \(n\) separable extension \(L/K\) and let \(\mf{o}\) be an order of \(\mc{O}/\smc{O}\). Then \(I_{\mf{o}}\) is an abelian group with identity \(\mf{o}\).
    \end{theorem}
    \begin{proof}
      Associativity and commutativity of \(I_{\mf{o}}\) are obvious. The identity is \(\mf{o}\) because every invertible fractional ideal is a finitely generated \(\mf{o}\)-submodule of \(L\). Lastly, every fractional ideal is invertible by definition of \(I_{\mf{o}}\).
    \end{proof}
    
    Let \(P_{\mf{o}}\) denote the subgroup of principal fractional ideals of \(I_{\mf{o}}\). In fact, \(P_{\mf{o}}\) contains every principal fraction ideal of \(\mf{o}\) because every principal fraction ideal is invertible. As \(I_{\mf{o}}\) is abelian by the previous result, \(P_{\mf{o}}\) is normal. The \textbf{Picard group}\index{Picard group} \(\Pic(\mf{o})\) of \(\mf{o}\) is defined to be the quotient
    \[
      \Pic(\mf{o}) = I_{\mf{o}}/P_{\mf{o}}.
    \]
