\chapter{Integrality and Dedekind Domains}
  ...
  \section{\todo{Orders}}
    ...
    Let \(P_{\mf{o}}\) denote the subgroup of principal fractional ideals of \(I_{\mf{o}}\). As \(I_{\mf{o}}\) is abelian by the previous result, \(P_{\mf{o}}\) is normal. The \textbf{Picard group}\index{Picard group} \(\Pic(\mf{o})\) of \(\mf{o}\) is defined to be the quotient
    \[
