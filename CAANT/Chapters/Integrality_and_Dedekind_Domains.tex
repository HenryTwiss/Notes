\chapter{Integrality and Dedekind Domains}
  ...
  \section{\todo{Orders}}
    ...
    \begin{proof}
      ...
      \[
        \phi:I(\smc{O}) \to \bigop_{\mf{p}}P(\smc{O}_{\mf{p}}) \qquad \mf{a} \mapsto (\mf{a}_{\mf{p}})_{\mf{p}},
      \]
      induced by localization. To prove the first statement, we must show that this is an isomorphism. \todo{xxx}
    \end{proof}
